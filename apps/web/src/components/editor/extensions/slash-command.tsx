...
import { QrCode, ScissorsLineDashed, SeparatorHorizontal, Text } from 'lucide-react';
...
const getSuggestionItems = ({ query }: { query: string }) => {
  return [
    ...
    {
      title: 'QR Code',
      description: 'Add qrcode',
      searchTerms: ['qr', 'code', '2d'],
      icon: <QrCode size={18} />,
      command: ({ editor, range }: CommandProps) => {
        editor
          .chain()
    ...
    // {
    //   title: 'Paper cut',
    //   description: 'Add paper cut',
    //   searchTerms: ['paper', 'cut'],
